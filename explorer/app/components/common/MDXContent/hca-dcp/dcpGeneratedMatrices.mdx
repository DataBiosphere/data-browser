...
All DCP Generated Matrices include [quality control metrics](https://data.humancellatlas.org/pipelines/qc-metrics). The 10x matrices include raw counts. Smart-seq2 matrices include TPMs and
