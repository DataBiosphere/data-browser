...
const singleProjectProjects = [
    Object.assign({}, PROJECT_ROW_SINGLE_VALUES.projects[0], {
        ...
        publications: [
            {
                publicationTitle:
                    "Transcriptional profiling of 1.3 Million Brain Cells with the Chromium Single Cell 3' Solution",
                publicationUrl: "http://google.com",
            },
        ],
    }),
];
export const PROJECT_SINGLE_VALUES = Object.assign(
    {},
    PROJECT_ROW_SINGLE_VALUES,
    {
...
export const PROJECT_VALUES_ACROSS_MULTIPLE_OBJECTS = Object.assign(
    {},
    PROJECT_ROW_VALUES_ACROSS_MULTIPLE_OBJECTS,
    {
