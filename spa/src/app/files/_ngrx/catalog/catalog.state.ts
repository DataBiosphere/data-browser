...
export class CatalogState {
     ...
     * @returns {CatalogState}
     */
    public fetchCatalogsSuccess(
        action: FetchCatalogsSuccessAction
    ): CatalogState {
     ...
     *
     */
    public setCatalogUpdatedSinceLastVisit(
        action: SetCatalogUpdatedSinceLastVisitAction
    ) {
        return new CatalogState(
            this.atlas,
            this.catalog,
