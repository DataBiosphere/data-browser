 ...
 */
export const selectCatalogsInit = createSelector(
    selectCatalogState,
    (state) => state.init
);
 ...
 */
export const selectCatalogUpdate = createSelector(
    selectCatalogState,
    (state) => state.catalogUpdate
);

/**
 * Return the default catalog for the current environment.
 */
export const selectDefaultCatalog = createSelector(
    selectCatalogState,
    (state) => state.atlas.defaultCatalog
);

/**
 * Returns true if the catalog has updated since the user's last visit.
 */
export const selectCatalogUpdatedSinceLastVisit = createSelector(
    selectCatalogState,
    (state) => state.catalogUpdatedSinceLastVisit
);
