...
export function  getDefaultState)() {
    return {
        fileFacetNames: [],
        selectedfacetsByName: new Map<string, FileFacet>(),
...
//             this.fileFacetNames.map(name => this.fileFacetsByName.get(name)).reduce((acc, facet) => {
...
//
//
//     public setSelectedTerms(facets: URLSearchParams[]) {
//
//
//     }
//
