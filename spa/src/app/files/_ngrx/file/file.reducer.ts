...
export function reducer(
    ...
    switch (action.type) {
        ...
        case FetchFileFileLocationSuccessAction.ACTION_TYPE:
            return state.fetchFileFileLocationSuccess(
