...
export function reducer(state: ProjectState = ProjectState.getDefaultState(), action: Action): ProjectState {
    ...
    switch (action.type) {
        ...
        case ClearProjectMatrixArchivePreviewAction.ACTION_TYPE:
            return state.clearProjectMatrixArchivePreviews(action as ClearProjectMatrixFileLocationsAction);
        ...
        case FetchProjectMatrixArchivePreviewRequestAction.ACTION_TYPE:
            return state.fetchProjectMatrixArchivePreviewRequest(action as FetchProjectMatrixArchivePreviewRequestAction);
        ...
        case FetchProjectMatrixArchivePreviewSuccessAction.ACTION_TYPE:
            return state.fetchProjectMatrixArchivePreviewSuccess(action as FetchProjectMatrixArchivePreviewSuccessAction);
