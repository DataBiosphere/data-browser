...
export function reducer(
    state: IntegrationState = IntegrationState.getDefaultState(),
    action: Action
): IntegrationState {
    switch (action.type) {
        ...
        case FetchIntegrationsByProjectIdSuccessAction.ACTION_TYPE:
            return state.fetchIntegrationsByProjectIdSuccess(
                action as FetchIntegrationsByProjectIdSuccessAction
            );
