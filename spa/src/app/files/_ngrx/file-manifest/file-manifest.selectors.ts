 ...
 */
export const selectFileManifest =
    createFeatureSelector<FileManifestState>("fileManifest");
 ...
 */
export const selectFileManifestFileTypeSummaries = createSelector(
    selectFileManifest,
    (state: FileManifestState) => state.fileTypeSummaries
);
 ...
 */
export const selectFileManifestManifestResponse = createSelector(
    selectFileManifest,
    (state: FileManifestState) => state.manifestResponse
);
 ...
 */
export const selectProjectFileFormatsFileFacet = createSelector(
    selectFileManifest,
    (state) => {
        return state.filesFacets.find(
 ...
 */
export const selectProjectFileSummary = createSelector(
    selectFileManifest,
    (state: FileManifestState) => state.projectFileSummary
);

/**
 * Return the project download-specific search terms.
 */
export const selectProjectSelectedSearchTerms = createSelector(
    selectFileManifest,
    (state: FileManifestState) => state.selectedProjectSearchTerms
);

/**
 * Return the project species count.
 */
export const selectProjectSpeciesCount = createSelector(
    selectFileManifest,
    (state: FileManifestState) => state.projectSpeciesFacet
);
