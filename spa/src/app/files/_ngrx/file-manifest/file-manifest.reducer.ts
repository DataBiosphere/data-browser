...
export function reducer(
    state: FileManifestState = FileManifestState.getDefaultState(),
    action: Action
): FileManifestState {
    switch (action.type) {
        ...
        case ClearFileManifestUrlAction.ACTION_TYPE:
            return state.clearFileManifestUrl(
                action as ClearFileManifestUrlAction
            );
        ...
        case FetchFilesFacetsSuccessAction.ACTION_TYPE:
            return state.receiveFilesFacets(
                action as FetchFilesFacetsSuccessAction
            );
        ...
        case FetchFileManifestFileTypeSummariesSuccessAction.ACTION_TYPE:
            return state.fetchFileTypeSummariesSuccess(
                action as FetchFileManifestFileTypeSummariesSuccessAction
            );
        ...
        case FetchFileManifestUrlSuccessAction.ACTION_TYPE:
            return state.fetchFileManifestUrlSuccess(
                action as FetchFileManifestUrlSuccessAction
            );
        ...
        case FetchProjectFileSummarySuccessAction.ACTION_TYPE:
            return state.fetchProjectFileSummary(
                action as FetchProjectFileSummarySuccessAction
            );
        ...
        case FetchProjectSpeciesFacetSuccessAction.ACTION_TYPE:
            return state.setProjectSpeciesFacet(
                action as FetchProjectSpeciesFacetSuccessAction
            );
