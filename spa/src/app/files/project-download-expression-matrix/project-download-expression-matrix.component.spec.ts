...
describe("ProjectDownloadExpressionMatrixComponent", () => {

    let component: ProjectDownloadExpressionMatrixComponent;
    let fixture: ComponentFixture<ProjectDownloadExpressionMatrixComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(ProjectDownloadExpressionMatrixComponent);
