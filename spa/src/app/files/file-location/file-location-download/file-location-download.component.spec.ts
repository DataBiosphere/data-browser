...
describe("FileLocationDownloadComponent", () => {
    ...
    it("triggers click handler on click of download", () => {
        ...
        const downloadDE = fixture.debugElement.query(By.css(".download-not-started"));
    ...
    it("displays spinner when file location is in progress", () => {
        ...
        const spinnerDE = fixture.debugElement.query(By.css(".download-in-progress"));
    ...
    it("displays check mark when file location completes", () => {
        ...
        const completeDE = fixture.debugElement.query(By.css(".download-complete"));
