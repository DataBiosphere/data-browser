            ...
            donorOrganisms: [
                {
                    ...
                    organismAgeRange: [
                        { gte: 536112000.0, lte: 536112000.0 },
                        {
                            gte: 1198368000.0,
                            lte: 1198368000.0,
                        },
                        { gte: 1608336000.0, lte: 1608336000.0 },
                        { gte: 1860624000.0, lte: 1860624000.0 },
                    ],
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 1639872000.0, lte: 1639872000.0 },
                        {
                            gte: 1576800000.0,
                            lte: 1734480000.0,
                        },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 1324512000.0, lte: 1324512000.0 },
                        {
                            gte: 1671408000.0,
                            lte: 1671408000.0,
                        },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 1261440000.0, lte: 1387584000.0 },
                        {
                            gte: 1419120000.0,
                            lte: 1545264000.0,
                        },
                        { gte: 1734480000.0, lte: 1860624000.0 },
                        { gte: 2049840000.0, lte: 2175984000.0 },
                    ],
                    biologicalSex: ["female", "male"],
                    disease: ["normal"],
                },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 1545264000.0, lte: 1545264000.0 },
                        {
                            gte: 1576800000.0,
                            lte: 1576800000.0,
                        },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAgeRange: [
                        ...
                        { gte: 1576800000.0, lte: 1576800000.0 },
                        { gte: 1639872000.0, lte: 1639872000.0 },
                    ],
                    biologicalSex: ["female", "male"],
                    disease: [null],
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 662256000.0, lte: 662256000.0 },
                        {
                            gte: 819936000.0,
                            lte: 819936000.0,
                        },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 630720000.0, lte: 788400000.0 },
                        {
                            gte: 946080000.0,
                            lte: 1103760000.0,
                        },
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{ value: "80", unit: "year" }],
                    organismAgeRange: [
                        { gte: 599184000.0, lte: 599184000.0 },
                        {
                            gte: 883008000.0,
                            lte: 883008000.0,
                        },
