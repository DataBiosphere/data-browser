    ...
    hits: [
        {
            ...
            donorOrganisms: [
                {
                    ...
                    organismAgeRange: [
                        [536112000.0, 536112000.0],
                        [1198368000.0, 1198368000.0],
                        [1608336000.0, 1608336000.0],
                        [1860624000.0, 1860624000.0],
                    ],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 38, totalSize: 418064570672},
            ],
        },
        {
            protocols: [
            ...
            projects: [
                {
                    ...
                    laboratory: [
                        "Farber Lab; Columbia Center for Translational Immunology",
                        "Human Cell Atlas Data Coordination Platform",
                        "Sims Lab; Department of Systems Biology",
                    ],
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [1639872000.0, 1639872000.0],
                        [1576800000.0, 1734480000.0],
                        [2049840000.0, 2049840000.0],
                    ],
                    biologicalSex: ["male"],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 32, totalSize: 496164231119},
                {
                    format: "unknown",
                    count: 80,
        ...
        },
        {
            ...
            projects: [
                {
                    ...
                    laboratory: [
                        ...
                        "Lions Eye Donation Services",
                        "National Institute for Aging",
                        "Save Sight Institute",
                        "Stem Cells and Regenerative Medicine Section, NIHR Great Ormond Street Hospital Biomedical Research Centre",
                    ],
                    ...
                    insdcStudyAccessions: [null],
                    supplementaryLinks: [
                        "https://github.com/IMB-Computational-Genomics-Lab/scGPS",
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [1324512000.0, 1324512000.0],
                        [1671408000.0, 1671408000.0],
                        [2522880000.0, 2522880000.0],
                    ],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 15, totalSize: 101869450565},
                {
                    format: "unknown",
                    count: 25,
                    totalSize: 344662182,
        ...
        },
        {
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [1261440000.0, 1387584000.0],
                        [1419120000.0, 1545264000.0],
                        [1734480000.0, 1860624000.0],
                        [2049840000.0, 2175984000.0],
                    ],
                    biologicalSex: ["female", "male"],
                    disease: ["normal"],
                },
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 18, totalSize: 53857782294},
                {
                    format: "pdf",
                    count: 3,
                    totalSize: 15762678,
        ...
        },
        {
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [1545264000.0, 1545264000.0],
                        [1576800000.0, 1576800000.0],
                        [1671408000.0, 1671408000.0],
                        [1986768000.0, 1986768000.0],
                        [2144448000.0, 2144448000.0],
                        [2175984000.0, 2175984000.0],
                        [2302128000.0, 2302128000.0],
                        [2396736000.0, 2396736000.0],
                        [2459808000.0, 2459808000.0],
                        [2522880000.0, 2522880000.0],
                        [2680560000.0, 2680560000.0],
                    ],
                    biologicalSex: ["female", "male"],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 50, totalSize: 32304816501},
                {
                    format: "pdf",
                    count: 2,
                    totalSize: 204869,
        ...
        },
        {
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 6, totalSize: 83729759795},
            ],
        },
        {
            protocols: [
            ...
            donorOrganisms: [
                {
                    ...
                    organismAgeRange: [
                        ...
                        [819936000.0,
                            819936000.0],
                        [914544000.0, 914544000.0],
                        [1009152000.0, 1009152000.0],
                        [1135296000.0, 1135296000.0],
                        [1229904000.0, 1229904000.0],
                        [1576800000.0, 1576800000.0],
                        [1639872000.0, 1639872000.0],
                    ],
                    biologicalSex: ["female", "male"],
        ...
        },
        {
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 44, totalSize: 158079432433},
            ],
        },
        {
            protocols: [
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [662256000.0, 662256000.0],
                        [819936000.0, 819936000.0],
                        [1292976000.0, 1292976000.0],
                        [1387584000.0, 1387584000.0],
                        [2049840000.0, 2049840000.0],
                    ],
                    biologicalSex: ["female", "male"],
                    disease: ["normal"],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 120, totalSize: 258844470961},
                {
                    format: "unknown",
                    count: 25,
                    totalSize: 503179820,
        ...
        },
        {
            ...
            samples: [
                {
                    ...
                    id: [
                        ...
                        "325C-WGS",
                        "325C12hSplBulkRNA",
                        "325C24hOesophagusBulkRNA",
                        "325C72hOesophagusBulkRNA",
                        "325C72hSplBulkRNA",
                        "325CFrSplBulkRNA",
                        "325CFreshOesophagusBulkRNA",
                        "328C24hOesophagusBulkRNA",
                        "328C72hOesophagusBulkRNA",
                        "328CFreshOesophagusBulkRNA",
                        "337C-WGS",
                        "337C12hSplBulkRNA",
                        "337CClinSplBulkRNA",
                        "343BClinLngBulkRNA",
                        ...
                        "356C-WGS",
                        "356C12hLngBulkRNA",
                        "356C12hOesophagusBulkRNA",
                        "356C24hSplBulkRNA",
                        "356C72hLngBulkRNA",
                        "356C72hSplBulkRNA",
                        "362C24hOesophagusBulkRNA",
                        "362C72hOesophagusBulkRNA",
                        "367C-WGS",
                        "367C12hOesophagusBulkRNA",
                        "367C24hOesophagusBulkRNA",
                        "367C72hLngBulkRNA",
                        "367C72hOesophagusBulkRNA",
                        "367CClinLngBulkRNA",
                        "367CFrLngBulkRNA",
                        "368C-WGS",
                        "368C24hLngBulkRNA",
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [630720000.0, 788400000.0],
                        [1103760000.0, 1261440000.0],
                        [1576800000.0, 1734480000.0],
                        [1892160000.0, 2049840000.0],
                        [2207520000.0, 2365200000.0],
                    ],
                    biologicalSex: ["female", "male"],
                    disease: ["normal"],
                },
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 361, totalSize: 3151293835880},
                {
                    format: "pdf",
                    count: 6,
                    totalSize: 8420344,
        ...
        },
        {
            ...
            donorOrganisms: [
                {
                    ...
                    genusSpecies: ["Homo sapiens"],
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [[567648000.0, 1892160000.0]],
                    biologicalSex: ["unknown"],
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 2244, totalSize: 80050236577},
            ],
        },
        {
            protocols: [
            ...
            donorOrganisms: [
                {
                    ...
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [
                        [599184000.0, 599184000.0],
                        [1103760000.0, 1103760000.0],
                    ],
                    biologicalSex: ["female", "male"],
                    disease: ["normal"],
                },
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 24, totalSize: 106097400109},
                {
                    format: "unknown",
                    count: 45,
                    totalSize: 658015719,
        ...
        },
        {
            ...
            projects: [
                {
                    ...
                    supplementaryLinks: [
                        "https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-6678/",
                        "https://www.ebi.ac.uk/arrayexpress/experiments/E-MTAB-6701/",
                        "https://www.ebi.ac.uk/ena/data/view/PRJEB25794",
                        "https://www.ebi.ac.uk/ena/data/view/PRJEB28266",
                    ],
                },
            ],
            samples: [
                {
                    ...
                    id: [
                        "blood_from_donor_D4",
                        "blood_from_donor_D5",
                        "decidua_from_donor_D1",
                        "decidua_from_donor_D2",
                        "decidua_from_donor_D3",
                        "decidua_from_donor_D4",
                        "decidua_from_donor_D5",
                        "decidua_sample_10",
                        "decidua_sample_12",
                        "decidua_sample_6",
                        "decidua_sample_7",
                        "decidua_sample_8",
                        "decidua_sample_9",
                        "peripheral_blood_sample_6",
                        "peripheral_blood_sample_7",
                        "peripheral_blood_sample_8",
                        "peripheral_blood_sample_9",
                        "placenta_sample_101",
                        "placenta_sample_111",
                        "placenta_sample_121",
                        "placenta_sample_81",
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 15287, totalSize: 1510927190031},
                {
                    format: "txt",
                    count: 37985,
                    totalSize: 149206433,
        ...
        },
        {
            ...
            donorOrganisms: [
                {
                    ...
                    genusSpecies: ["Homo sapiens"],
                    organismAge: [{value: "80", unit: "year"}],
                    organismAgeRange: [[662256000.0, 662256000.0]],
                    biologicalSex: ["male"],
                    disease: [
                        "end stage renal failure",
                        "hemolytic-uremic syndrome",
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 14, totalSize: 47431062150},
                {
                    format: "pdf",
                    count: 4,
                    totalSize: 22053225,
        ...
        },
        {
            ...
            fileTypeSummaries: [
                {format: "fastq.gz", count: 36, totalSize: 50140859942},
                {
                    format: "unknown",
                    count: 15,
                    totalSize: 212437849,
    ...
    termFacets: {
        organ: {
            terms: [
                ...
                {term: "decidua", count: 1},
                {term: "embryo", count: 1},
                {
                    term: "esophagus",
                    count: 1,
                },
                {term: "immune system", count: 1},
                {term: "liver", count: 1},
                {
                    term: "mediastinal lymph node",
                    count: 1,
                },
                {term: "placenta", count: 1},
                {term: "spleen", count: 1},
            ],
            total: 23,
            type: "terms",
        ...
        sampleEntityType: {
            terms: [
                {term: "specimens", count: 19},
                {
                    term: "cell_lines",
                    count: 4,
                },
                {term: "organoids", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        ...
        instrumentManufacturerModel: {
            terms: [
                ...
                {term: "Illumina Hiseq 2500", count: 2},
                {term: "Illumina NovaSeq 6000", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        institution: {
            terms: [
                {term: "EMBL-EBI", count: 12},
                {
                    term: "University of California, Santa Cruz",
                    count: 6,
                },
                {
                    term: "EMBL-EBI European Bioinformatics Institute",
                    count: 3,
                },
                {
                ...
                {
                    term: "Max Planck Institute for Evolutionary Anthropology",
                    count: 1,
                },
                {
                ...
                {term: "University of Utah", count: 1},
                {term: "Wellcome Trust Sanger Institute", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        donorDisease: {
            terms: [
                ...
                {
                    term: "reversible cerebral vasoconstriction syndrome",
                    count: 1,
                },
                {
                ...
                {term: "ventricular tachycardia", count: 1},
                {term: null, count: 1},
            ],
            total: 23,
            type: "terms",
        ...
        preservationMethod: {
            terms: [
                ...
                {term: "hypothermic preservation media at 2-8C", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        genusSpecies: {
            terms: [
                {term: "Homo sapiens", count: 23},
                {term: "Mus musculus", count: 8},
            ],
            total: 28,
            type: "terms",
        },
        ...
        disease: {
            terms: [
                ...
                {term: "ulcerative colitis (disease)", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        specimenOrganPart: {
            terms: [
                ...
                {term: "renal pelvis", count: 1},
                {term: "retina", count: 1},
                {
                    term: "retinal neural layer",
                    count: 1,
                },
                {term: "umbilical cord blood", count: 1},
                {term: "ureter", count: 1},
            ],
            total: 23,
            type: "terms",
        ...
        contactName: {
            terms: [
                {term: "Mallory,Ann,Freeberg", count: 8},
                {
                    term: "Laura,,Huerta",
                    count: 4,
                },
                ...
                {term: "Akbar,,Shakoor", count: 1},
                {term: "Albert,,Vitale", count: 1},
                {
                    term: "Alex,K,Shalek",
                    count: 1,
                },
                ...
                {term: "Blair,K,Gage", count: 1},
                {term: "Bo,,Li", count: 1},
                {
                    term: "Boaz,,Barak",
                    count: 1,
                },
                {term: "Boaz,,Levi", count: 1},
                {term: "Brendan,T,Innes", count: 1},
                {
                ...
                {term: "Damra,,Camat", count: 1},
                {term: "Dana,, Pe'er", count: 1},
                {
                ...
                {term: "David,,Grant", count: 1},
                {term: "Denise,,Morgan", count: 1},
                {
                    term: "Donna,L,Farber",
                    count: 1,
                },
                {term: "Douglas,A,Melton", count: 1},
                {term: "Ed,,Lein", count: 1},
                {
                    term: "Elizabeth,,Lee",
                    count: 1,
                },
                ...
                {term: "Emily,,Relton", count: 1},
                {term: "Emily,,Welby", count: 1},
                {
                    term: "Eric,, Gauchat",
                    count: 1,
                },
                {term: "Erin,C,Bush", count: 1},
                {term: "Erinn,,Donnelly", count: 1},
                {
                    term: "Eshita,,Sharma",
                    count: 1,
                },
                ...
                {term: "Gordon,,Keller", count: 1},
                {term: "Graeme,,Pollock", count: 1},
                {
                    term: "Guy Ledergor",
                    count: 1,
                },
                ...
                {term: "Heather,, Eckart", count: 1},
                {term: "Helmut,G,Rennke", count: 1},
                {
                    term: "Ian,,Glass",
                    count: 1,
                },
                {term: "Ian,D,McGilvray", count: 1},
                {term: "Ido Amit", count: 1},
                {
                    term: "Ilia,,Kurochkin",
                    count: 1,
                },
                {term: "Itai,,Yana", count: 1},
                {term: "Ivan,,Linares", count: 1},
                {
                    term: "Ivana,,Kim",
                    count: 1,
                },
                {term: "J,Gray,Camp", count: 1},
                {term: "Jafar,S,Jabbari", count: 1},
                {
                    term: "James,,Kinchen",
                    count: 1,
                },
                {term: "Jane,,Lee", count: 1},
                {term: "Jane,C,Sowden", count: 1},
                {
                    term: "Jason,E,Fish",
                    count: 1,
                },
                {term: "Jeff,C,Liu", count: 1},
                {term: "Jennie,,Close", count: 1},
                {
                    term: "Jennifer,Hyoje,Ryu",
                    count: 1,
                },
                {term: "Jeremy,,Miller", count: 1},
                {term: "Jiarui,,Ding", count: 1},
                {
                    term: "Jill,,Henault",
                    count: 1,
                },
                ...
                {term: "John,,Ferdinand", count: 1},
                {term: "John,,Mich", count: 1},
                {
                    term: "John,,Phillips",
                    count: 1,
                },
                {term: "John,R,Ferdinand", count: 1},
                {term: "John,Y,Kwon", count: 1},
                {
                    term: "Jonathan,,Ting",
                    count: 1,
                },
                ...
                {term: "Kerstin,B,Meyer", count: 1},
                {term: "Kevin,,Loudon", count: 1},
                {
                    term: "Kiet,,Ngo",
                    count: 1,
                },
                ...
                {term: "Laura,,Cubitt", count: 1},
                {term: "Leah,,Owen", count: 1},
                {
                    term: "Lewis,Y,Liu",
                    count: 1,
                },
                {term: "Liam,,Bolt", count: 1},
                {term: "Ling,,Zhu", count: 1},
                {
                    term: "Lyujie,,Fang",
                    count: 1,
                },
                {term: "Maayan,,Baron", count: 1},
                {term: "Manu,, Setty", count: 1},
                {
                ...
                {term: "Nir,,Hacohen", count: 1},
                {term: "Oliver,,Stegle", count: 1},
                {
                    term: "Olivia,,Fong",
                    count: 1,
                },
                ...
                {term: "Paul,,Greig", count: 1},
                {term: "Paul,A,Welling", count: 1},
                {
                    term: "Peng-Yuna,,Wang",
                    count: 1,
                },
                {term: "Peter,,Smibert", count: 1},
                {term: "Peter,A,Sims", count: 1},
                {
                    term: "Peter,A,Szabo",
                    count: 1,
                },
                ...
                {term: "Puspa,,Thapa", count: 1},
                {term: "Qingnan,,Liang", count: 1},
                {
                    term: "Quan,,Nguyen",
                    count: 1,
                },
                {term: "Quin,,Wills", count: 1},
                {term: "Rahul,,Gupta", count: 1},
                {
                    term: "Rahul,,Satija",
                    count: 1,
                },
                ...
                {term: "Rory,,Bowden", count: 1},
                {term: "Roser,,Vento-Tormo", count: 1},
                {
                    term: "Rui,,Chen",
                    count: 1,
                },
                ...
                {term: "Sai,,Ramakrishnan", count: 1},
                {term: "Sai,W,Chung", count: 1},
                {
                    term: "Sam,,Behjati",
                    count: 1,
                },
                ...
                {term: "Sandy,SC,Hung", count: 1},
                {term: "Sangbae,,Kim", count: 1},
                {
                ...
                {term: "Takashi,,Senda", count: 1},
                {term: "Timothy,,Tickle", count: 1},
                {
                    term: "Ting,,Zhang",
                    count: 1,
                },
                ...
                {term: "Trygve,,Bakken", count: 1},
                {term: "Tu,,Nguyen", count: 1},
                {
                    term: "Tyler,,Burks",
                    count: 1,
                },
                ...
                {term: "Vilas,,Menon", count: 1},
                {term: "William,,Ge", count: 1},
                {
                    term: "Xian,,Adiconis",
                    count: 1,
                },
                {term: "Xue-Zhong,,Ma", count: 1},
                {term: "Xuesen,,Cheng", count: 1},
                {
                    term: "Yim,Ling,Cheng",
                    count: 1,
                },
                {term: "Yumei,,Li", count: 1},
                {term: "Zhisong,,He", count: 1},
                {
                    term: "Zigong,,Shao",
                    count: 1,
                },
                {term: "Zinaida, A, Perova", count: 1},
                {term: "Zizhen,,Yao", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        ...
        effectiveOrgan: {
            terms: [
                ...
                {term: "hematopoietic system", count: 3},
                {term: "kidney", count: 3},
                {
                    term: "pancreas",
                    count: 3,
                ...
                {term: "esophagus", count: 1},
                {term: "heart", count: 1},
                {
                    term: "liver",
                    count: 1,
                },
                {term: "mediastinal lymph node", count: 1},
                {term: "placenta", count: 1},
                {
                    term: "spleen",
                    count: 1,
                },
                {term: "stem cell", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        ...
        cellLineType: {
            terms: [
                {term: "induced pluripotent", count: 2},
                {
                    term: "primary",
                    count: 2,
                },
                {term: "stem cell-derived", count: 2},
                {term: "stem cell", count: 1},
                {
                    term: null,
                    count: 18,
        ...
        libraryConstructionApproach: {
            terms: [
                ...
                {term: "10x v3 sequencing", count: 1},
                {term: "CEL-seq2", count: 1},
                {
                    term: "CITE-seq",
                    count: 1,
                },
                ...
                {term: "DroNc-seq", count: 1},
                {term: "Drop-Seq", count: 1},
                {
                    term: "Drop-seq",
                    count: 1,
                },
                {term: "MARS-seq", count: 1},
                {term: "Seq-Well", count: 1},
                {
                    term: "Smart-Seq",
                    count: 1,
                },
                {term: "cDNA library construction", count: 1},
                {term: "sci-RNA-seq", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        ...
        laboratory: {
            terms: [
                ...
                {
                    term: "Farber Lab; Columbia Center for Translational Immunology",
                    count: 1,
                },
                {
                    term: "Fish",
                ...
                {
                    term: "Garvan\u2010Weizmann Centre for Cellular Genomics",
                    count: 1,
                },
                {
                    term: "Ghanekar",
                ...
                {term: "Rebecca Fitzgerald", count: 1},
                {term: "Regev Lab", count: 1},
                {
                    term: "Sapisochin",
                    count: 1,
                },
        ...
        selectedCellType: {
            terms: [
                ...
                {term: "endothelial cell", count: 2},
                {term: "epithelial cell", count: 2},
                {
                    term: "fibroblast",
                    count: 2,
                },
                ...
                {
                    term: "CD34-positive, CD38-negative hematopoietic stem cell",
                    count: 1,
                },
                {
                    term: "CD45-",
                ...
                {term: "neural cell", count: 1},
                {term: "neuron", count: 1},
                {
                    term: "pancreatic PP cell",
                    count: 1,
                },
                {term: "splenocyte", count: 1},
                {term: "stromal cell", count: 1},
            ],
            total: 23,
            type: "terms",
        },
        specimenDisease: {
            terms: [
                ...
                {term: "type 2 diabetes mellitus", count: 1},
                {term: "ulcerative colitis (disease)", count: 1},
            ],
            total: 23,
            type: "terms",
        ...
        fileFormat: {
            terms: [
                {term: "fastq.gz", count: 23},
                {term: "bam", count: 14},
                {
                    term: "csv",
                    count: 14,
                },
                {term: "matrix", count: 14},
                {term: "unknown", count: 11},
                {
                    term: "pdf",
                    count: 6,
                },
                {term: "bai", count: 4},
                {term: "results", count: 4},
                {
                    term: "txt",
                    count: 4,
                },
