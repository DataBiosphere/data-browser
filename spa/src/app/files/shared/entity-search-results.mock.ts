                ...
                cellSuspensions: [
                    {
                        organ: ["lymph node"],
                        organPart: [],
                        selectedCellType: ["CD11b+CD11c+DC"],
                        totalCells: 91,
                    },
                ],
                fileTypeSummaries: [
                ...
                cellSuspensions: [
                    {
                        organ: ["lymph node"],
                        organPart: [],
                        selectedCellType: ["CD11b+ Macrophages/monocytes"],
                        totalCells: 91,
                    },
                ],
                fileTypeSummaries: [
...
export const DEFAULT_PROJECTS_ENTITY_SEARCH_RESULTS =
    buildDefaultProjectsEntitySearchResults(
        DEFAULT_PROJECTS_ENTITY_SEARCH_RESULTS_JSON
    );
