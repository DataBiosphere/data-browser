    ...
    cellSuspensions: [
        {
            organ: ["embryo"],
            organPart: ["blastocyst"],
            selectedCellType: ["inhibitory interneuron"],
            totalCells: 100,
        },
    ],
    bundles: [
...
export const FILE_MULTIPLE_VALUES_SINGLE_OBJECT = {
    protocols: [
        {
            ...
            workflow: ["smartseq2", "a"],
            workflowVersion: ["v2.3.0", "a"],
        },
    ],
    entryId: "ee6a75bd-3252-41ee-b253-425bbd377f0c",
    projects: [
    ...
    samples: [
        {
            sampleEntityType: ["cellLines", "a"],
            id: ["cell_line_at_day_26", "a"],
            modelOrgan: ["foo", "bar"],
        },
    ],
    specimens: [
        {
            id: ["embryo_WAe001-A", "a"],
            organ: ["embryo", "a"],
            organPart: ["blastocyst", "a"],
            disease: ["normal", "a"],
            preservationMethod: ["a", "b"],
            source: ["specimen_from_organism", "a"],
        },
    ],
    cellLines: [
        {
            id: ["cell_line_WAe001-A", "cell_line_at_day_26"],
        },
    ],
    donorOrganisms: [
        {
            id: ["donor_WAe001-A", "a"],
            genusSpecies: ["Homo sapiens", "a"],
            organismAge: [
                {
                    value: "56",
                    unit: "year",
    ...
    cellSuspensions: [
        {
            organ: ["embryo", "a"],
            organPart: ["blastocyst", "a"],
            selectedCellType: ["inhibitory interneuron", "a"],
            totalCells: 100,
        },
    ],
    bundles: [
