...
@Component({
    selector: "release-visualizations-modal",
    templateUrl: "./release-visualizations-modal.component.html",
    styleUrls: ["./release-visualizations-modal.component.scss"]
})
export class ReleaseVisualizationsModalComponent implements OnDestroy, OnInit {

    // Locals
    private ngDestroy$ = new Subject();
    private releaseFilesReferrer: boolean;
    private state$ = new BehaviorSubject<ReleaseVisualizationsModalState>({
        loaded: false
    });
    ...
    constructor(
        ...
        private dialogRef: MatDialogRef<ReleaseVisualizationsModalComponent>,
