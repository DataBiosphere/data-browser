...
describe("CatalogFormComponent", () => {
    ...
    it("triggers click handler on click of download", () => {
        ...
        const radioGroupDE = fixture.debugElement.query(By.css("mat-radio-group"));
    ...
    it("emits on change of catalog value", () => {
        ...
        expect(store.dispatch).toHaveBeenCalledWith(new SelectCatalogAction(changeEvent.value));
    });
