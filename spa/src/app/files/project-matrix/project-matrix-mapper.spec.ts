...
describe("MatrixMapper", () => {
    ...
    it("transforms matrices tree into matrix views", () => {
        ...
        const contributorMatrices =
            PROJECT_ROW_SINGLE_VALUES.projects[0].contributedAnalyses;
        const matrixViews =
            rowMapper["flattenResponseTree"](contributorMatrices);
    ...
    it("merges files with matching urls", () => {
        ...
        const contributorMatrices =
            PROJECT_ROW_SINGLE_VALUES.projects[0].contributedAnalyses;
        const dupedMatrixViews =
            rowMapper["flattenResponseTree"](contributorMatrices);
        const matrixViews =
            rowMapper["mergeDuplicatedMatrixViews"](dupedMatrixViews);
