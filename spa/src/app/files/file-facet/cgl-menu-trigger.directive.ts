...
export class CGLMenuTrigger implements AfterViewInit, OnDestroy {
    ...
    @Input("cglMenuTriggerFor") menu: MdMenuPanel;
    ...
    private _checkMenu() {
        if (!this.menu) {
            ...
            throw new Error("Error attemping to init CGL menu trigger");
        }
    }
