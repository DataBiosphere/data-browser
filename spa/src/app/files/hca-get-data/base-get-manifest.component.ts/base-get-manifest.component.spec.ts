...
import { BaseGetManifestComponent } from "./base-get-manifest.component";
...
describe("BaseGetManifestComponent", () => {

    let component: BaseGetManifestComponent;
    let fixture: ComponentFixture<BaseGetManifestComponent>;
    ...
    beforeEach(async(() => {
        ...
        fixture = TestBed.createComponent(BaseGetManifestComponent);
