...
import { GetManifestState } from "./get-manifest.state";
...
@Component({
    selector: "base-get-manifest",
    template: "" // No template for base class
})
export class BaseGetManifestComponent implements OnDestroy, OnInit {

    // Template variables
    public portalURL: string;
    public state$: Observable<GetManifestState>;
