...
export class DataReleasePolicyLinkComponent implements OnInit {
    ...
    // View child
    @ViewChild("link", {static: true, read: ViewContainerRef}) anchorRef: ViewContainerRef;
    ...
    private initViewContainers() {
        ...
        const linkComponent = this.siteConfigService.getDataReleasePolicyLinkComponent();
