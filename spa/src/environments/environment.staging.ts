export const environment = {
    production: true,
    dataURL: "https://service.staging.explore.data.humancellatlas.org",
    dcpHealthCheckUrl: "https://status.dev.data.humancellatlas.org/service/dcp-health-check-staging",
